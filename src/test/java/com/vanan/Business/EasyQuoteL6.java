...
/**
 * Basic Price with Mailing Hard copy
 */
public class EasyQuoteL6 extends TestBase {
    ...
    public void runTypingTest() {
        ...
        for (int i = 1; i <= fileProcessing.getRowUsed(); i++) {
            ...
            easyQuotePage.setSingleFileDetail("Document", service4 + i,
                    ...
                    fileProcessing.getNumericCellData(i, 3) + "", fileProcessing.getNumericCellData(i, 4)+ "", "", "Test", 1,(int)fileProcessing.getNumericCellData(i, 6));
            enterMailingNotaryDetails();
            waitingTime(5);
            double totalUnitCost = fileProcessing.getNumericCellData(i, 3) * fileProcessing.getNumericCellData(i, 4);
            double total = totalUnitCost + fileProcessing.getNumericCellData(i, 5);
    ...
    public void enterMailingNotaryDetails() {

        easyQuotePage.enterMailingHardCopyDetails("AUTOMATION", "TESTING", "address1",
                "address2", "state", "city", "234234", "option");
    }
}
