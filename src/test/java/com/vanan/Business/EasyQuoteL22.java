...
/**
 * Basic Price with Time code + Quality Check(Transcription, Translation)
 */
public class EasyQuoteL22 extends TestBase {
    ...
    public void runTranscriptionTest() {
        fileProcessing.setExcelFile(level22, service1);
        for (int i = 1; i <= fileProcessing.getRowUsed(); i++) {
            ...
            double timeCode = roundValues((fileProcessing.getFloatCellData(i, 5) * (int) fileProcessing.getFloatCellData(i, 3)));
            double additional = timeCode + (fileProcessing.getFloatCellData(i, 8)* (int) fileProcessing.getFloatCellData(i, 3));
        ...
        fileProcessing.writeFileContent(level22);
    }

    @Test(priority = 1)
    public void runTranslationTest() {
        fileProcessing.setExcelFile(level22, service2);
        for (int i = 1; i <= fileProcessing.getRowUsed(); i++) {
            System.out.println("Source : " + fileProcessing.getCellData(i, 0));
            ...
            double timeCode = roundValues((fileProcessing.getFloatCellData(i, 6) * (int) fileProcessing.getFloatCellData(i, 4)) + (fileProcessing.getFloatCellData(i, 9) * (int) fileProcessing.getFloatCellData(i, 4)));
