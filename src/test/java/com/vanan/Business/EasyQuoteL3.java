...
/**
 * Basic Price with Quality Check(Transcription, Translation)
 */
public class EasyQuoteL3 extends TestBase {
    ...
    public void runTranscriptionTest() {
        ...
        for (int i = 1; i <= fileProcessing.getRowUsed(); i++) {
            ...
            double qc = roundValues((fileProcessing.getFloatCellData(i, 5) * (int) fileProcessing.getFloatCellData(i, 3)));
            double total = roundValues(totalUnitCost + qc);
    ...
    public void runTranslationTest() {
        ...
        for (int i = 1; i <= fileProcessing.getRowUsed(); i++) {
            ...
            double qc = roundValues((fileProcessing.getFloatCellData(i, 6) * (int) fileProcessing.getFloatCellData(i, 4)));
            double total = roundValues(totalUnitCost + qc);
            double transactionFee = roundValues(total * 0.05);
            double orderTotal = roundValues(total + transactionFee);
